...
{
    public class FaturaTuruViewModel : ObservableObject
    {
        private readonly FaturaTuruModel _model;
        ...
        public FaturaTuruViewModel()
        {

            var csvPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "Analizler", "aylik_faturalar.csv");
            _model = new FaturaTuruModel(csvPath);
            ...
            XAxes = new ObservableCollection<Axis>
            {
                new Axis
                {
                    Labels = new List<string> { "Alış Fat", "Alış İrs", "Müstahsil", "Satış Fat", "Satış Fat İade", "Satış İrsaliyesi", "İptal", "İptal Satış Faturası" }, // Sabit etiketler
